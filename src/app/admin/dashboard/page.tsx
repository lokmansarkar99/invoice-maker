    ...
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {statCards.map((stat, i) => (
          <div
            key={i}
            className="p-6 bg-black/80 backdrop-blur-sm border border-cyan-500/50 shadow-[0_0_20px_rgba(6,182,212,0.15)] hover:border-cyan-400 transition-colors group relative overflow-hidden"
          >
            ...
            <div className="flex items-center justify-between mb-4 relative z-10">
               <h3 className="text-cyan-600 font-bold text-xs tracking-widest group-hover:text-cyan-400 transition-colors">
                 // {stat.title}
               </h3>
              <div className="p-2 bg-cyan-950/50 border border-cyan-900 group-hover:border-cyan-500/50 transition-colors shadow-[0_0_10px_rgba(6,182,212,0.1)]">
                {stat.icon}
              </div>
            </div>
            <p className="text-3xl font-black text-cyan-300 relative z-10 tracking-wider">
              {stat.value}
            </p>
          </div>
        ))}

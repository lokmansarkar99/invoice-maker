  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      <div className="flex items-center gap-4 mb-8 border-b border-cyan-500/30 pb-4">
        <Link href={`/admin/invoices/${id}`} className="p-2 border border-cyan-900 bg-black/50 hover:bg-cyan-950/50 hover:border-cyan-500/50 transition-colors text-cyan-600 hover:text-cyan-400">
          <ArrowLeft size={20} />
        </Link>

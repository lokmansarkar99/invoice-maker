  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      <div className="flex items-center gap-4 mb-8">
        <Link href={`/admin/invoices/${id}`} className="p-2 bg-white/5 hover:bg-white/10 rounded-lg transition-colors text-white">
          <ArrowLeft size={20} />
        </Link>
                ...
                {items.length === 0 ? (
                  ...
                  <tr key={index} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                    <td className="py-3 px-4">
                      ...
                      {item.stock !== '?' && <div className="text-xs text-gray-400">Stock: {item.stock}</div>}
                    </td>
                    <td className="py-3 px-4">
                      <input 
                        type="number" 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="glass p-6 md:p-8 rounded-2xl">
            ...
            <button 
              type="submit" 
              disabled={saving}
              className="w-full mt-8 bg-blue-500 hover:bg-blue-600 disabled:opacity-50 text-white font-bold py-3 rounded-lg shadow-lg transition-all"
            >

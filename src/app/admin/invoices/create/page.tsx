  ...
  return (
    <div className="max-w-5xl mx-auto pb-12">
      <div className="flex items-center gap-4 mb-8 border-b border-cyan-500/30 light:border-slate-300 pb-4">
        <Link href="/admin/invoices" className="p-2 border border-cyan-900 light:border-slate-300 bg-black/50 light:bg-white hover:bg-cyan-950/50 hover:border-cyan-500/50 transition-colors text-cyan-600 light:text-slate-700 hover:text-cyan-400 light:hover:text-indigo-600">
          <ArrowLeft size={20} />
        </Link>

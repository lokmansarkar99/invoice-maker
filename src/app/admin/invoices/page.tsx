                ...
                invoices.map((invoice) => (
                  <tr key={invoice._id} className="border-b border-cyan-900/50 hover:bg-cyan-950/30 transition-colors group">
                    ...
                    <td className="py-3 px-4">
                      <span className={`px-2 py-1 text-[10px] font-bold tracking-widest border light:rounded-md light:shadow-sm ${
                        invoice.status === 'PAID' ? 'bg-cyan-950/50 text-cyan-400 border-cyan-500/50 shadow-[0_0_10px_rgba(6,182,212,0.3)] light:bg-emerald-100 light:text-emerald-700 light:border-emerald-200 light:shadow-none' :
                        invoice.status === 'DUE' ? 'bg-red-950/50 text-red-500 border-red-500/50 shadow-[0_0_10px_rgba(239,68,68,0.3)] light:bg-rose-100 light:text-rose-700 light:border-rose-200 light:shadow-none' :
                        invoice.status === 'PARTIAL DUE' ? 'bg-orange-950/50 text-orange-500 border-orange-500/50 shadow-[0_0_10px_rgba(249,115,22,0.3)] light:bg-orange-100 light:text-orange-700 light:border-orange-200 light:shadow-none' :
                        'bg-slate-950/50 text-slate-400 border-slate-500/50 shadow-[0_0_10px_rgba(100,116,139,0.3)] light:bg-slate-100 light:text-slate-700 light:border-slate-200 light:shadow-none'
                      }`}>
                        [{invoice.status}]
                      </span>
                    </td>

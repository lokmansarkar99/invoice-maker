    ...
    <div>
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
        ...
        <button 
          ...
          className="bg-teal-500 hover:bg-teal-600 text-black font-bold py-2 px-4 rounded-lg flex items-center gap-2 transition-colors"
        >
          <Plus size={20} />
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-white/10">
                <th className="py-3 px-4 text-gray-400 font-medium">Product</th>
                <th className="py-3 px-4 text-gray-400 font-medium">Standard Price</th>
                <th className="py-3 px-4 text-gray-400 font-medium">Stock</th>
              ...
              {loading ? (
                ...
                products.map((product) => (
                  <tr key={product._id} className="border-b border-white/5 hover:bg-white/5 transition-colors">
                    ...
                    <td className="py-3 px-4 text-gray-300">৳{product.standardPrice.toLocaleString()}</td>
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm z-50 flex items-center justify-center p-4">
          <div className="bg-[#0f172a] border border-white/10 rounded-2xl w-full max-w-md overflow-hidden">
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4">
              {modalError && <div className="p-3 bg-red-500/10 text-red-400 rounded-lg text-sm">{modalError}</div>}
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  <label className="text-sm font-medium text-gray-300">Standard Price (৳) *</label>
                  <input 
                    required 
                    type="number"
                    min="0"
              ...
              <div className="pt-4 flex justify-end gap-3">
                ...
                <button 
                  ...
                  className="bg-teal-500 hover:bg-teal-600 text-black font-bold py-2 px-6 rounded-lg transition-colors disabled:opacity-50"
                >

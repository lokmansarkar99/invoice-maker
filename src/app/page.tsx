...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full flex flex-col font-mono relative overflow-hidden bg-black text-cyan-300">
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <div className="flex items-center gap-4 group">
            ...
            <div className="flex items-center gap-2">
              <span className="text-2xl font-bold tracking-widest text-cyan-400 uppercase">SYS_INVOICE</span>
              <span className="hidden sm:flex items-center bg-cyan-950/30 text-cyan-500 text-[10px] font-bold px-2 py-1 border border-cyan-800 ml-2 uppercase tracking-widest animate-pulse">
                [LIVE_NODE]
              </span>
            </div>
          </div>
          
          <div className="hidden lg:flex items-center gap-8 font-bold text-xs text-cyan-600 uppercase tracking-widest">
          ...
          <div className="flex items-center gap-6">
            <div className="hidden md:block text-right">
              <div className="text-[10px] text-cyan-700 font-bold uppercase tracking-widest">OP_DESK</div>
              <div className="font-bold text-cyan-400 text-sm">{supportPhone}</div>
            </div>
            <Link href="/admin/login" className="bg-cyan-950/50 text-cyan-400 text-xs uppercase tracking-widest font-bold py-2.5 px-6 border border-cyan-500/50 hover:bg-cyan-900/50 hover:text-cyan-300 hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all">
              ROOT_ACCESS
            </Link>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 mt-12 flex-1 w-full flex flex-col mb-16 relative z-10">
        ...
        <div className="bg-black/80 backdrop-blur-md border border-cyan-500/50 p-8 shadow-[0_0_30px_rgba(6,182,212,0.15)] flex flex-col md:flex-row justify-between items-center mb-12 hover:border-cyan-400 transition-colors group">
          <div className="flex flex-col md:flex-row items-center md:items-start gap-6 w-full md:w-auto text-center md:text-left">
            ...
            <div className="flex-1">
              <div className="flex flex-col md:flex-row md:items-center gap-3 mb-4 justify-center md:justify-start">
                <h2 className="text-2xl md:text-3xl font-bold text-cyan-400 uppercase tracking-widest">
                  {store?.storeName || "INIT_STORE_DATA..."}
                </h2>
                <span className="bg-cyan-950/50 text-cyan-400 text-[10px] font-bold px-2 py-1 border border-cyan-500/50 flex items-center gap-1 w-fit mx-auto md:mx-0 uppercase tracking-wider">
                  <ShieldCheck size={12} /> SECURE_NODE
                </span>
              </div>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-3 text-xs text-cyan-600 font-bold uppercase tracking-wider">
          ...
          <div className="mt-8 md:mt-0 bg-cyan-950/30 border border-cyan-800 p-5 text-center w-full md:w-auto self-stretch flex flex-col justify-center">
            <div className="text-[10px] font-bold text-cyan-700 uppercase tracking-widest mb-1">// SYS_BIN_ID</div>
        ...
        <div className="bg-black/80 backdrop-blur-md border border-cyan-500/50 p-10 md:p-14 text-center shadow-[0_0_40px_rgba(6,182,212,0.2)] mb-16 relative">
          ...
          {/* <div className="inline-flex items-center bg-cyan-950/50 text-cyan-400 text-[10px] font-bold px-3 py-1.5 border border-cyan-500/50 mb-8 relative z-10 uppercase tracking-widest">
            <span className="w-2 h-2 bg-cyan-400 animate-pulse mr-2"></span>
            GUEST_TERMINAL_V1
          </div> */}
          <h1 className="text-3xl md:text-4xl font-bold mb-6 tracking-widest text-cyan-400 uppercase relative z-10">
            Execute {"<"}Search_Query{">"}
          </h1>
          <p className="text-cyan-600 text-sm max-w-2xl mx-auto mb-10 relative z-10 uppercase tracking-wider">
          ...
          <form onSubmit={handleSearch} className="max-w-3xl mx-auto relative flex flex-col md:flex-row gap-4 z-10">
            <div className="relative flex-1 group">
              ...
              <input 
                ...
                className="w-full bg-black/50 border border-cyan-900 pl-12 pr-6 py-4 text-lg text-cyan-300 placeholder-cyan-900/50 focus:outline-none focus:border-cyan-400 focus:shadow-[0_0_15px_rgba(6,182,212,0.2)] transition-all uppercase"
              />
            </div>
            <button 
              type="submit" 
              disabled={loading}
              className="bg-cyan-950/50 disabled:opacity-50 text-cyan-400 font-bold text-sm py-4 px-8 border border-cyan-500/50 hover:bg-cyan-900/50 hover:text-cyan-300 hover:shadow-[0_0_20px_rgba(6,182,212,0.4)] transition-all flex items-center justify-center gap-3 uppercase tracking-widest relative overflow-hidden submit-btn"
            >
          ...
          {error && (
            <div className="text-red-500 font-bold mt-6 bg-red-950/30 border-l-4 border-red-500 py-3 px-4 inline-block text-xs uppercase tracking-widest">
              {error}
            </div>
          )}
          
          <div className="mt-10 flex flex-wrap justify-center items-center gap-4 text-xs text-cyan-700 font-bold uppercase tracking-widest z-10 relative">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          ...
          <div className="bg-black/80 backdrop-blur-md border border-cyan-500/50 p-8 shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:border-cyan-400 transition-all flex flex-col group relative overflow-hidden">
            ...
            <h3 className="text-lg font-bold mb-3 text-cyan-400 uppercase tracking-widest relative z-10">Local_Auth</h3>
            ...
            <div className="text-[10px] font-bold text-cyan-500 flex items-center justify-between pt-4 border-t border-cyan-900 uppercase tracking-widest relative z-10">
          ...
          <div className="bg-black/80 backdrop-blur-md border border-cyan-500/50 p-8 shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:border-cyan-400 transition-all flex flex-col group relative overflow-hidden">
            ...
            <h3 className="text-lg font-bold mb-3 text-cyan-400 uppercase tracking-widest relative z-10">Sys_Verify</h3>
          ...
          <div className="bg-black/80 backdrop-blur-md border border-cyan-500/50 p-8 shadow-[0_0_20px_rgba(6,182,212,0.1)] hover:border-cyan-400 transition-all flex flex-col group relative overflow-hidden">
            ...
            <h3 className="text-lg font-bold mb-3 text-cyan-400 uppercase tracking-widest relative z-10">Print_Protocol</h3>
      ...
      {/* Footer */}
      <footer className="mt-auto relative z-10 bg-black/80 backdrop-blur-md border-t border-cyan-500/50 py-6 text-center text-cyan-700 text-[10px] uppercase tracking-widest font-bold">

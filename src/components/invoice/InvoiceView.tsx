...
export default function InvoiceView({ invoiceId, isAdmin = false }: { invoiceId: string, isAdmin?: boolean }) {
  ...
  const handleDelete = async () => {
    if (confirm("Delete Invoice? This action cannot be undone and will restore stock.")) {
      try {
